...
public class Reader : Ref<StreamReader>
{
    ...
    {
        field.Set("peek", new NativeFun("peek", 1, (args, field) =>
        {
        ...
        field.Set("read", new NativeFun("read", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("read_async", new AsyncNativeFun<Int>("read_async", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("read_token", new NativeFun("read_token", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("read_token_async", new AsyncNativeFun<Str>("read_token_async", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("readln", new NativeFun("readln", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("readln_async", new AsyncNativeFun<Str>("readln_async", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("read_all", new NativeFun("read_all", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("read_all_async", new AsyncNativeFun<Str>("read_all_async", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("is_end", new NativeFun("is_end", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("close", new NativeFun("close", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
        ...
        field.Set("dispose", new NativeFun("dispose", 1, (args, field) =>
        {
            if (args[0] is not Reader self)
                throw new ValueError("invalid argument");
